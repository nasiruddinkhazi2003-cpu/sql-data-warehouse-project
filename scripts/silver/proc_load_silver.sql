	...
	BEGIN TRY
		...
		SET @start_time = GETDATE();
			...
			CASE WHEN UPPER(TRIM( cst_marital_status)) = 'S' THEN 'Single'
				 ...
				 ELSE 'n/a' -- ABBREVIATION TO READABLE FORMAT
			...
			)t WHERE flag_last =1 ;--SELECTING MOST RECENT RECORD OF EACH CUSTOMER
		...
		SET @start_time = GETDATE();
			...
			CASE WHEN UPPER(TRIM(prd_line)) = 'M' THEN 'Mountain'
				 ...
				 ELSE 'n/a'
			END AS prd_line, -- MAP PRODUCT LINE CODES TO DESCTRIPTIVE VALUES
